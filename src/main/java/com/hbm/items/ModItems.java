...
public class ModItems {
	...
	public static Item welding_torch;
	public static Item welding_torch_desh;
	...
	public static void initializeItem() {
		...
		saw_iron = new ItemGregTool(GregToolType.SAW, null, 100).setUnlocalizedName("saw_iron");
		saw_steel = new ItemGregTool(GregToolType.SAW, null, 250).setUnlocalizedName("saw_steel");
		saw_desh = new ItemGregTool(GregToolType.SAW, null, 0).setUnlocalizedName("saw_desh");
		cutter_iron = new ItemGregTool(GregToolType.CUTTER, null, 100).setUnlocalizedName("cutter_iron");
		cutter_steel = new ItemGregTool(GregToolType.CUTTER, null, 250).setUnlocalizedName("cutter_steel");
		cutter_desh = new ItemGregTool(GregToolType.CUTTER, null, 0).setUnlocalizedName("cutter_desh");
		welding_torch = new ItemGregTool(GregToolType.WELDING_TORCH, null, 150).setUnlocalizedName("welding_torch");
		welding_torch_desh = new ItemGregTool(GregToolType.WELDING_TORCH, null, 0).setUnlocalizedName("welding_torch_desh");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(welding_torch, welding_torch.getUnlocalizedName());
		GameRegistry.registerItem(welding_torch_desh, welding_torch_desh.getUnlocalizedName());
