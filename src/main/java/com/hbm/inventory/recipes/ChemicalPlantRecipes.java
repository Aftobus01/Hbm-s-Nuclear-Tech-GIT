...
public class ChemicalPlantRecipes extends GenericRecipes<GenericRecipe> {
	...
	public void registerDefaults() {
		...
		this.register(new GenericRecipe("chem.strawberryicecream").setup(150, 100)
				...
				.inputItems(new OreDictStack(KEY_BUTTER, 2), new ComparableStack(Blocks.packed_ice, 1), new ComparableStack(GameRegistry.findItem("harvestcraft", "strawberryItem"), 4))
