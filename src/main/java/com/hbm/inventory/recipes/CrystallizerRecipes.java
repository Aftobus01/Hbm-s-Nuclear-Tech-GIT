...
public class CrystallizerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		registerRecipe(new ComparableStack(GameRegistry.findItem("appliedenergistics2", "item.ItemMultiMaterial"), 1, 1), new CrystallizerRecipe(new ItemStack(GameRegistry.findItem("buddingpolar", "budding_certus_quartz_block"), 1), 2_500).prod(0.0F).setReq(16), new FluidStack(Fluids.HYDROGEN, 300));
